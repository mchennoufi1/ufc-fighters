...
<div class="container">
    ...
    <br>
    <p class="card-header">Naam: UFC fighters</p>
    ...
    <p class="card-header">E-Mail: <a href="mailto: healthone@gmail.com">ufcfighters@gmail.com</a></p>
    <br>
    ...
    if(isset($_POST['verzenden'])){
        ...
        $query = $db->prepare("INSERT INTO reviews(naam,bericht)
                VALUES(:naam, :bericht)");
        $query->bindParam("naam", $naam);
        $query->bindParam("bericht", $bericht);
        if($query->execute()){
            echo "goed";
            $query = $db->prepare("SELECT * FROM reviews WHERE datumtijd");
            $query->execute();
